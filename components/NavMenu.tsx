        ...
        {open ? (
          <>
            ...
            <motion.nav
              ...
              className="fixed inset-y-0 right-0 z-50 flex h-dvh w-1/2 flex-col bg-[#111113]/98 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] shadow-2xl backdrop-blur-xl"
            >
